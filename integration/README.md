...
[![HACS Validation](https://img.shields.io/github/actions/workflow/status/bthos/ha-octopus-energy-es/validate-integration.yml?branch=main&label=HACS&logo=github)](https://github.com/bthos/ha-octopus-energy-es/actions/workflows/validate-integration.yml)
...
> - **For Lovelace card visualization**, install the separate [Octopus Energy España Consumption Card](https://github.com/bthos/ha-octopus-energy-es) plugin.
